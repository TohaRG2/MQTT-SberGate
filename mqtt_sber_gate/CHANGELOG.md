...
## 2.0.6 (16.02.2026)
- Добавлена сортировка устройств по любому полю. Датчики давления в HA могут иметь тип не только
"pressure", но и "atmospheric_pressure" - добавлена поддержка таких датчиков.
...
температурой и влажностью, если датчики находятся в составе одного устройства. (upd 06.02.2026) К сожалению, Сбер пока не поддерживает датчик давления и не отображает его в Салюте, поэтому данное изменение по сути ничего не меняет.
