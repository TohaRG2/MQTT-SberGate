...
температурой и влажностью, если датчики находятся в составе одного устройства. Upd (10.02.2026) К сожалению, Сбер не отображает значение давления в Салюте, поэтому по сути данное изменение ничего не добавляет.
